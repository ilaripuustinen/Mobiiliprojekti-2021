...
import virgoImage from "../../assets/Images/Horoscope/VirgoPicture.png"
                ...
                <ImageBackground source={require("../../assets/HoroBackground.png")} resizeMode="cover" style={styles.hsbackground}>
                    <ScrollView>
                        <View style={{ alignSelf: 'center', marginTop: 40 }}>
                            <Image style={{ width: 350, height: 350, }} source={virgoImage}></Image>
                        </View>
                        <View>
                            <Text style={styles.horoTitle}>Virgo</Text>
