...
import ariesImage from "../../assets/Images/Horoscope/AriesPicture.png"
                ...
                <ImageBackground source={require("../../assets/HoroBackground.png")} resizeMode="cover" style={styles.hsbackground}>
                    <ScrollView>
                        <View style={{ alignSelf: 'center', marginTop: 40 }}>
                            <Image style={{ width: 350, height: 350, }} source={ariesImage}></Image>
                        </View>
                        <View>
                            <Text style={styles.horoTitle}>Aries</Text>
